# -*- coding: utf-8 -*-
"""
Created on Thu Apr 13 18:55:43 2023
...
class Shuffle:
    ...
    def return_gs(self, gs1, gs2):
        ...
        self.gs1 = gs1
        self.gs1_hashable = GS(gs1)
        self.gs2 = gs2
        self.gs2_hashable = GS(gs2)

        self._subshuffle(self.gs1_hashable, self.gs2_hashable)
...
if __name__ == "__main__":
    import sys
    import os
    sys.path.insert(0, sys.path.append(os.getcwd()+"/../../Impulse Response GS/"))
    ...
    # These are worrisome, as the occur in the calculations but do not fit into a 
    # specified form.
    # bad1 = 0.48046875 / (_x0 + 1)
    # bad2 = 0.00520833333333333 / (_x0 + 1)**2
    ...
    _t0 = time.time()
    gs = shfl.iterate_gs(**RUN_PARAMS)
    print(f"time taken is {time.time()-_t0:.3f}")
