# -*- coding: utf-8 -*-
"""
Created on Tue Jun  6 10:18:58 2023
...
from shufflesym import binary_shuffle
...
def hard_equal(obj1, obj2):
    """
    Used for unit testing
    """
    cond1 = obj1.coeff == obj2.coeff
    cond2 = obj1.words == obj2.words
    cond3 = obj1.dens == obj2.dens
...
class TestPaperQuadratic(unittest.TestCase):
    ...
    def test_g1_manual(self):
        ...
        assert hard_equal(TestPaperQuadratic.g1, g1[0])
    ...
    def test_g2_manual(self):
        ...
        g2 = sorted(g2, key=hash)
        for g2_a, g2_b in zip(g2, TestPaperQuadratic.g2):
            assert hard_equal(g2_a, g2_b)
    ...
    def test_g3_manual(self):
        ...
        g3.extend(binary_shuffle(g1[0], g1[0]))
        g3 = shfl.collect(g3)

        for g3_term in g3:
            g3_term.prepend_multiplier(TestPaperQuadratic.multiplier)

        g3_terms = sorted(g3, key=hash)
    
        for g3_a, g3_b in zip(g3_terms, TestPaperQuadratic.g3):
            assert hard_equal(g3_a, g3_b)
    ...
    def test_iterate_gs1(self):
        ...
        assert hard_equal(g1, TestPaperQuadratic.g1)
