# -*- coding: utf-8 -*-
"""
Created on Thu Jun  8 08:23:55 2023
...
from params import A, m, c, k1, k3, plot, t
...
_k3, _x0, _x1, _a1, _a2, _A = symbols("k3 x0 x1 a1 a2 A")
...
scheme = shfl.iterate_gs(g0, mult_cube, 3, 2, return_type=dict)
...
np.save("y1_sym_cube.npy", y11)
np.save("y2_sym_cube.npy", y21)
np.save("y3_sym_cube.npy", y31)
